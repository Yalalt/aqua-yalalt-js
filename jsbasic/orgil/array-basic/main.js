let studentAges = [18,19,20,21,22,23,24,26,24,22,20,18,19,23,24,25,26,27,28,29];
let studentsNames = ['sharawnyambuu','baljinnyam', 'munkhbat', 'dorjoo', 'dulmaa', 'yalalt', 'orgil', 'anhaa', 'batsukh', 'narandelgerekh', 'nomin', 'enkhtuul', 'maral', 'murun', 'munkhmainbayarlakh'];
