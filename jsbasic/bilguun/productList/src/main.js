let productsTag = document.getElementById("products");
let formd = document.getElementById("form");
let newTaskInput = document.getElementById("searchValue");
...
function getTenProducts() {
  fetch("https://dummyjson.com/products?limit=10")
    ...
    .then((data) => {
      ...
      //   let cBodyFooter = document.createElement("div");
      ...
      //   discount.textContent = "Disc: " + product.discountPercentage + "%";
      ...
      //   cBodyFooter.appendChild(btn);
      //   card.appendChild(cBody);
      //   card.appendChild(cBodyFooter);
...
formd.addEventListener("submit", function (e) {
  e.preventDefault();
  searchProducts(newTaskInput.value);
